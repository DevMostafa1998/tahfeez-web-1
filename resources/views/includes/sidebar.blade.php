    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="true">
                ...
                @php
                    $isEduActive = request()->routeIs('group.*') || request()->routeIs('student.*') || request()->routeIs('user.*') || request()->routeIs('quran_tests.*');
                @endphp
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('group.index') }}" class="nav-link {{ request()->routeIs('group.*') ? 'active' : '' }}">
                                <i class="nav-icon bi {{ request()->routeIs('group.*') ? 'bi-circle-fill' : 'bi-circle' }}"></i>
                                <p>المجموعات</p>
                            </a>
                        </li>
                        @if (auth()->user()->is_admin)
                            <li class="nav-item">
                                <a href="{{ route('student.index') }}" class="nav-link {{ request()->routeIs('student.*') ? 'active' : '' }}">
                                    <i class="nav-icon bi {{ request()->routeIs('student.*') ? 'bi-circle-fill' : 'bi-circle' }}"></i>
                                    <p>الطلاب</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('user.index') }}" class="nav-link {{ request()->routeIs('user.*') ? 'active' : '' }}">
                                    <i class="nav-icon bi {{ request()->routeIs('user.*') ? 'bi-circle-fill' : 'bi-circle' }}"></i>
                                    <p>المستخدمين</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('quran_tests.index') }}" class="nav-link {{ request()->routeIs('quran_tests.*') ? 'active' : '' }}">
                                    <i class="nav-icon bi {{ request()->routeIs('quran_tests.*') ? 'bi-circle-fill' : 'bi-circle' }}"></i>
                                    <p>الاختبارات</p>
                                </a>
                            </li>
                        @endif
                ...
                @php
                    $isAttendanceActive = request()->routeIs('attendance.*') || request()->routeIs('teachers.attendance');
                @endphp
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('attendance.index') }}" class="nav-link {{ request()->routeIs('attendance.*') ? 'active' : '' }}">
                                <i class="nav-icon bi {{ request()->routeIs('attendance.*') ? 'bi-circle-fill' : 'bi-circle' }}"></i>
                                <p>حضور الطلاب</p>
                            </a>
                        </li>
                        @if (auth()->user()->is_admin)
                            <li class="nav-item">
                                <a href="{{ route('teachers.attendance') }}" class="nav-link {{ request()->routeIs('teachers.attendance') ? 'active' : '' }}">
                                    <i class="nav-icon bi {{ request()->routeIs('teachers.attendance') ? 'bi-circle-fill' : 'bi-circle' }}"></i>
                                    <p>حضور المحفظين</p>
                                </a>
                            </li>
                        @endif
                ...
                <li class="nav-item {{ $isReportsActive ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('reports.memorization') }}" class="nav-link {{ request()->routeIs('reports.memorization') ? 'active' : '' }}">
