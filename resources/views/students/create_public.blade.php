            ...
            <div class="row">
                <div class="col-12">
                    <div class="card border-0 shadow-sm"
                        ...
                        <form action="{{ route('student_public.store') }}" method="POST" id="createStudentForm"
                            autocomplete="off">
                            @csrf
                            <div class="card-body p-4">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6 text-start">
                                            <label class="form-label small fw-bold text-secondary mb-1">
                                                <i class="bi bi-person-fill text-dark me-1"></i>المعلم المسؤول
                                            </label>
                                            <select name="user_id" class="form-control form-control-sm border-0 bg-light px-3 py-2">
                    ...
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                ...
                                .then(() => {
                                    window.location.href = "{{ route('student_public.index') }}";
                                });
                        }
                    },
                    error: function(xhr) {
