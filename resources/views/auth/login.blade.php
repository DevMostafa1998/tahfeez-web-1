        ...
        <div class="login-card mx-auto">
            ...
            <div class="card-header-custom">
                <div class="logo-wrapper">
                    <img src="./assets/img/quran.png" alt="الشعار">
                </div>
                <h5 class="fw-bold mb-0 text-dark">تسجيل الدخول</h5>
                <p class="text-muted small mt-1">مرحبا بك, يرجى تسجيل الدخول للمتابعة</p>
            </div>
            ...
            <div class="card-body p-4 pt-2">
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="identity_number" class="form-control" placeholder="أدخل رقم الهوية"
