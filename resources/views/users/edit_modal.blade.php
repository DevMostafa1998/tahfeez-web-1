            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 15px; text-align: right;" dir="rtl">
                ...
                <div class="modal-body compact-body bg-white">
                    ...
                    <div class="row gx-3 mb-4">
                        ...
                        <div class="col-md-2 text-start">
                            <label class="fw-bold small text-truncate">رقم الجوال</label>
                            <input type="tel" name="phone_number" class="form-control bg-light border-0 py-2"
                                value="{{ $user->phone_number }}" required>
                        </div>
                        <div class="col-md-3 text-start">
                            <label class="fw-bold small">العنوان الحالي</label>
                    ...
                    <div class="row gx-3">
                        <div class="col-md-2 text-start">
                            <label class="fw-bold small">الصلاحية</label>
                        ...
                        <div class="col-md-2 text-start">
                            <label class="fw-bold small">التصنيف</label>
                        ...
                        <div class="col-md-4 text-start">
                            <label class="fw-bold small">كلمة المرور الجديدة</label>
                            <input type="password" name="password" class="form-control bg-light border-0 py-2"
                                placeholder="اختياري">
                        </div>
                        <div class="col-md-4 text-start">
                            <label class="fw-bold small">تأكيد كلمة المرور</label>
