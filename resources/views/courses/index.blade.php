                ...
                <table class="table table-hover align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-outline-warning rounded-circle me-1 edit-btn"
                ...
                <div class="modal-body p-4">
                    <div class="row g-3 text-start">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg bg-light border-0" placeholder="اسم الدورة" required>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                ...
                <div class="modal-body p-4 text-start">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label fw-bold mb-2">اسم الدورة</label>
                            <input type="text" name="name" id="edit_name" class="form-control form-control-lg bg-light border-0" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold mb-2">الفئة المستهدفة</label>
                            <select name="type" id="edit_type" class="form-select form-select-lg bg-light border-0" required>
                                <option value="all">الجميع</option>
                                <option value="teachers">المحفظين</option>
                                <option value="students">الطلاب</option>
                            </select>
